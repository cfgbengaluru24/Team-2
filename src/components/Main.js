...
const App = () => {
  ...
  // Use useEffect to simulate componentDidMount for page load actions
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <button id="login_btn" onClick={openNewTab}>Login as Admin</button>
          <a href="#" className="w3-bar-item w3-button">Home</a>
          <a href="#" className="w3-bar-item w3-button">Sholas</a>
        </div>
      </nav>
      ...
      <div className="w3-main" style={{ marginLeft: '250px' }}>
        ...
        <div className="w3-display-container w3-container">
          ...
          >
            ...
            <h1 className="w3-hide-small">Elephants</h1>
            <p></p>
          </div>
        </div>
      </div>
